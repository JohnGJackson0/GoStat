...
class PooledLessThanDistributionTest extends PooledVarianceDistributionTest {
    public PooledLessThanDistributionTest(TTestData data){
        super(data);
    }

    public PooledLessThanDistributionTest(List<DataPoint> list1, List<DataPoint> list2) {
        super(list1, list2);
    }
